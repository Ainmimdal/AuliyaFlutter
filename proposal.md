...
- Special rewards for long-term goals
...
**Tab 3 - Bonus:**
- Similar to Tab 2 but for special long-term rewards
- Larger star prices
- Special unlock animations
...
dependencies:
  ...
  # Carousel/Scroll (Child Selector)
...
- User data stored securely in Firebase with proper security rules
...
- Option to delete all data (GDPR compliant)
...
5. **Scale**: Support future feature expansion and user growth
